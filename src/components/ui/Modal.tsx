    ...
    <Transition show={isOpen}>
      <Dialog onClose={onClose} className="relative z-50">
        ...
        <div className="fixed inset-0 flex min-h-full items-center justify-center p-4">
          ...
          >
            <DialogPanel className="relative w-full max-w-lg mx-auto bg-background text-text p-2 rounded-xl shadow-xl border border-simpson-gray dark:border-simpson-dark text-left flex flex-col gap-4 overflow-y-auto max-h-[90vh]">
              <button
                onClick={onClose}
