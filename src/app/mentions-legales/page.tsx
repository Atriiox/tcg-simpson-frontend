        ...
        <div className="space-y-8 text-simpson-gray dark:text-simpson-white/80 text-sm sm:text-base leading-relaxed">
          ...
          <section className="space-y-2">
            ...
            <p>
              ...
              utilisateurs de l'application l'identité des différents
              intervenants dans le cadre de sa réalisation et de son suivi :
            </p>
            <p className="pl-4 border-l-2 border-simpson-orange/30 dark:border-simpson-yellow/30 italic">
              <strong>Propriétaire / Éditeur : </strong> TCG Simpson  <br />
              <strong>Contact : </strong> TCG Simpson  <br />
              <strong>Statut :</strong> Projet de démonstration de fin d'études
              / Projet personnel.
            </p>
          </section>
          ...
          <section className="space-y-2">
            ...
            <p>
              ...
              <strong>Vercel Inc.</strong>, dont le
          ...
          <section className="space-y-2">
            ...
            <p>
              TCG Simpson est propriétaire des droits de
              propriété intellectuelle ou détient les droits d’usage sur les
              éléments accessibles sur le site (textes, graphismes, logos,
              icônes).
            </p>
            <div className="bg-simpson-light/40 dark:bg-simpson-dark/30 p-4 rounded-xl border border-simpson-gray/5 text-[13px]">
              <strong>Note importante (Fair Use / Projet Fan) :</strong> Ce site
              est un projet à but non lucratif et à usage purement pédagogique.
              Les visuels, univers et personnages de la licence{" "}
              <em>« Les Simpson »</em> appartiennent exclusivement à la{" "}
              <strong>20th Century Studios / The Walt Disney Company</strong>.
              Aucun usage commercial n'est fait de ces ressources.
            </div>
          </section>
          ...
          <section className="space-y-2">
            ...
            <p>
              ...
              modification et de suppression des informations collectées.
            </p>
            <p>
              Ce projet utilise des cookies techniques ou des jetons (Tokens)
              strictement nécessaires pour assurer le maintien de votre session
              d'authentification et l'état de votre inventaire de
              cartes/boutique. Aucune donnée n'est revendue à des tiers.
            </p>
          </section>
          ...
          <section className="space-y-2">
            ...
            <p>
              ...
              droit français ou européen. En dehors des cas où la loi ne le
