...
export default function Shop() {
        ...
        <div className="w-full bg-white/40 dark:bg-simpson-darklight/40 backdrop-blur-md p-2 rounded-2xl border border-white/40 dark:border-white/5 shadow-lg flex flex-col sm:flex-row items-center justify-between gap-6">
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-xs text-simpson-gray dark:text-simpson-white/60 mt-0.5">
          ...
          <div className="flex flex-col sm:flex-row items-center gap-4 w-full sm:w-auto">
            {!dailyReady && isMounted && (
              <div className="text-center sm:text-right">
                <span className="text-[10px] uppercase font-bold tracking-wider text-simpson-gray block mb-0.5">
                  Disponible dans
                </span>
  ...
  `}
      ...
      <Modal
        ...
        onClose={() => !isPurchasing && setIsDonutModalOpen(false)}
      >
