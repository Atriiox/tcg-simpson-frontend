        ...
        <div className="flex flex-col gap-4 bg-black/2 dark:bg-white/2 rounded-2xl p-4 border border-black/5 dark:border-white/5">
          ...
          <div className="grid grid-cols-2 gap-4 px-1 py-0.5">
            <div className="min-w-0">
              <span className="text-[11px] font-bold text-black/60 dark:text-white/60 block truncate">
                Cartes uniques
              </span>
              <span className="text-sm font-black">
                ...
                <span className="text-xs font-normal opacity-40">
                  /{" "}
                  {profile?.stats?.legendaryTotal
                    ? stats.legendaryTotal + stats.rareTotal + stats.commonTotal
                    : 40}
                </span>
              </span>
            </div>
      ...
      <div className="flex flex-col gap-5 border-t md:border-t-0 md:border-l border-black/5 dark:border-white/5 pt-6 md:pt-0 md:pl-6 justify-between">
        <div className="space-y-4">
          ...
          <div className="flex flex-col gap-1.5">
            ...
            <div
              className={`h-11 rounded-xl flex items-center px-3.5 gap-3 transition-all bg-black/3 dark:bg-white/3 border ${formik.touched.pseudo && formik.errors.pseudo ? "border-red-500/50" : "border-transparent focus-within:border-simpson-lightblue/40 focus-within:bg-transparent"}`}
            >
              ...
              {isEditingUsername && (
                <div className="flex gap-3 font-bold shrink-0">
                  ...
                  <button
                    ...
                    className="text-simpson-lightblue hover:opacity-80 cursor-pointer"
                  >
                    Enregistrer
                  </button>
                </div>
          ...
          <div className="flex flex-col gap-1.5">
            <div className="flex justify-between items-center px-0.5">
              ...
              {isEditingPassword ? (
                ...
                <button
                  ...
                  className="text-xs font-bold text-simpson-lightblue opacity-90 hover:opacity-100 cursor-pointer transition-opacity"
                >
                  Modifier
                </button>
              )}
            ...
            <div
              className={`h-11 rounded-xl flex items-center px-3.5 gap-3 transition-all bg-black/3 dark:bg-white/3 border ${formik.touched.password && formik.errors.password ? "border-red-500/50" : "border-transparent focus-within:border-simpson-lightblue/40 focus-within:bg-transparent"}`}
            >
          ...
          <div className="flex justify-between items-center pt-2 px-0.5">
            ...
            >
              ...
              >
                <div
                  className={`w-5 h-5 rounded-full bg-linear-to-b from-[#3b3a4e] to-[#272733] shadow-[inset_0_1px_1px_rgba(255,255,255,0.2),0_2px_4px_rgba(0,0,0,0.5)] transition-transform duration-300 z-10 ${isDark ? "translate-x-5" : "translate-x-0"}`}
                />
                <div
                  className={`w-2.5 h-2.5 rounded-full border transition-all duration-300 ${isDark ? "border-simpson-lightblue bg-simpson-lightblue/20 shadow-[0_0_5px] shadow-simpson-lightblue -translate-x-5" : "border-simpson-orange bg-simpson-orange/20 shadow-[0_0_5px] shadow-simpson-orange translate-x-0"}`}
                />
              </div>
            </button>
          </div>
