...
export default function BoosterOpener({
  ...
  return (
    ...
    */
    <div
      className="bg-simpson-white dark:bg-simpson-dark rounded-2xl shadow-2xl w-[95vw] sm:w-[80vw] max-w-5xl h-[85vh] sm:h-[82vh] flex flex-col font-main overflow-hidden"
      data-testid="booster-opener-modal"
    >
      {/* Header fixe */}
      <div className="flex items-center justify-between px-6 pt-5 pb-4 border-b border-simpson-gray/10 shrink-0">
        ...
        {onClose && (
          <button
            ...
            data-testid="booster-modal-close-icon"
          >
            <FaTimes size={18} />
          </button>
        )}
      ...
      <div className="flex-1 overflow-y-auto custom-scrollbar flex flex-col items-center justify-center p-6 sm:py-10 gap-4">
        {!hasCards && (
          <div className="w-full flex flex-col items-center justify-center my-auto">
            <div
              className="w-full max-w-70 sm:max-w-85 aspect-3/4 flex justify-center items-center relative"
              data-testid="booster-pack-3d-container"
            ...
            {isLoading && (
              <p
                className="text-body text-simpson-orange font-semibold animate-pulse mt-4"
                data-testid="booster-loading-indicator"
              >
            ...
            {error && (
              <div
                ...
                data-testid="booster-error-message"
              >
                {error}
              </div>
            )}
        ...
        {hasCards && (
          ...
          */
          <div
            ...
            data-testid="booster-cards-result"
          >
            <p
              className="text-medium text-simpson-orange font-semibold tracking-widest uppercase text-xs sm:text-sm"
              data-testid="booster-cards-count"
            >
        ...
        <div className="flex gap-3 justify-center items-center px-6 py-4 border-t border-simpson-gray/10 dark:border-white/5 shrink-0 bg-gray-50/50 dark:bg-black/10">
          {shouldShowButton && (
            <Button
              ...
              onClick={handleReset}
              data-testid="booster-reset-button"
            >
              Ouvrir un autre
            </Button>
          )}
          ...
          {onClose && (
            <Button
              ...
              onClick={onClose}
              data-testid="booster-close-button"
            >
              Fermer
            </Button>
          )}
